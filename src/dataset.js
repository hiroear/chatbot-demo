const defaultDataset = {
  "init": {
    ...
    question: "こんにちは！😊　荒木へのご用件はなんでしょうか？"
  },
  ...
  "job_offer": {
    answers: [
      ...
      {content: "自動化ツールを開発してほしい", nextId: "automation_tool"},
  ...
  "webapp": {
    ...
    question: "Webアプリ開発についてですね。コチラからお問合せできます。"
  },
  ...
  "consultant": {
    ...
    question: "荒木は普段からYoutubeでキャリアについて発信しています。また、私が運営するエンジニア向け学習コミュニティ内でも相談に乗っていますよ。"
  },
  ...
  "community_activity": {
    ...
    question: "フロントエンド向けの教材の提供、キャリアや勉強法に関するメルマガの配信、週一のオンライン作業会などを開催しています！\n詳細はYoutube動画で紹介しています。"
  },
